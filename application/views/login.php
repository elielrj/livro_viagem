                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Livro Viagem!</h1>
                                    </div>
...
<script>
    ...
    function setError(index){
        divs[index].style.border = '2px solid #e63636';
    ...
    function login() {
       ...
       alert(form[1].value)
        ...
        if (form[1].value == '9524' && form[0].value == 'elielrj@gmail.com') {
            alert("Login efetuado com sucesso!");
            confirm(index.php);            
            confirm('index.php/estadocontroller.php');
